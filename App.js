...
class HomeScreen extends React.Component {
  ...
  handlePhone = (text) => {
   ...
   login = (username, email, phone) => {
    fetch('http://192.168.1.11/tr_reactnative/insert.php',{
      method:'POST',
      headers:{
...
class DetailsScreen extends React.Component {
  ...
  componentDidMount(){
    fetch('http://192.168.1.11/tr_reactnative/getdataUsers.php')
    .then((response)=>response.json())
    .then((responseJson) => {
      this.setState({
        isLoading:false,
...
class UpdateDataUser extends React.Component {
  ...
  UpdateUser= () =>{
    fetch('http://192.168.1.11/tr_reactnative/update.php', {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
  ...
  DeleteUser= () =>{
    fetch('http://192.168.1.11/tr_reactnative/delete.php', {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
